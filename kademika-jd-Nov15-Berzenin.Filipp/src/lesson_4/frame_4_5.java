 ...
 * @version 3.0
 */
public class frame_4_5 extends JPanel {
...
//		
//	
//		System.out.println(getQuadrant(tankX,tankY));
//			
...
//		System.out.println(getQuadrant(512,512));
		...
		bulletX = 25;
		bulletY = 225;
		System.out.println(Arrays.toString(battleField[bulletY/64]));
...
//		for (int i=0; i<bulletX || i<bulletY; i++) {
		if (battleField[indexVertikal][indexHorizontal] == "B") {
		 ...
		 return true;}
		 if (battleField[indexVertikal][indexHorizontal] == " ") {
			 return false;
		 }
		 }
			 return false;
...
//	}
	...
	public static void main(String[] args) throws Exception {
		frame_4_5 bf = new frame_4_5();
		bf.runTheGame();
	}

	public frame_4_5() throws Exception {
